...
document.addEventListener("DOMContentLoaded", () => {
    ...
    checkoutBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await fetch('http://206.189.80.129:8000/api/create-checkout-session', {
                method: 'POST',
